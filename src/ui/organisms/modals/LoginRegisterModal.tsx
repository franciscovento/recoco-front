...
const LoginRegisterModal = ({ login }: Props) => {
  ...
  return (
    <>
      {isLogin ? (
        ...
        <RegisterModal setIsLogin={setIsLogin} />
      )}
    </>
  );
};
...
const RegisterModal = ({ setIsLogin }: IRegisterModal) => {
  return (
    <div className="bg-white rounded-xl shadow-app-card grid sm:grid-cols-5  relative gap-8 pt-4 sm:pt-0">
      ...
      <div className="text-left col-span-3 pt-12 sm:py-12 px-6 order-1 sm:order-2 sm:pr-12">
        ...
        <form className="flex flex-col gap-2">
          ...
          <div className="text-center flex flex-col items-center">
            <Button type="submit" className="w-[203px] max-w-full">
              Crear cuenta
            </Button>
            <button
